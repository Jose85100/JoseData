...
swe <- read.csv("E:/ECONOMETRÍA II/Taller final/ECB Data Portal_20240604025325.csv",sep = ";")
View(swe)
hci <- read.csv("E:/ECONOMETRÍA II/Taller final/ECB Data Portal_20240604043000.csv", sep = ";")
...
plot(swee, 
     main="Long-term interest rate for convergence purposes - Swedish krona - Sweden", 
     sub="Monthly",
     xlab="Time", 
     ylab="Rate",
     col="darkblue")  # Línea más gruesa
plot(hicp, 
     main="HICP - Overall index, Sweden, Monthly", 
     sub="Monthly",
     xlab="Time", 
     ylab="Rate",
     col="darkblue")  # Línea más gruesa
